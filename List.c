...
// 	add_to_list(&list,"wacawaca");	
// 	add_to_list(&list,"caquita");	
// 	add_to_list(&list,"RESENGANNN!!!");	
// 	add_to_list(&list,"wacawaca");	
// 	add_to_list(&list,"caquita");	
// 	add_to_list(&list,"RESENGANNN!!!");	
...
// 	print_list(&list);
// 	char* a = get_and_delete_from_list(&list,1);
// 	printf("%s \n", a);
// 	remove_from_list_for_position(&list,4);
// 	remove_from_list_for_position(&list,2);
	
// 	print_list(&list);


// // 	//set_from_list(&list,3,"XXXXXXXXXX");
// // 	//printf("%s \n", get_from_list(&list,3));
// // 	//print_list(&list);
// // 	printf("%s \n", pop_from_list(&list));
// // 	print_list(&list);
// // 	printf("%s \n", shift_from_list(&list));
// // 	print_list(&list);
